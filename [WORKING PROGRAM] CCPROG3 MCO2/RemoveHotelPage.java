...
/**
 * Represents a page for removing hotels in the Hotel Reservation System GUI.
 */
public class RemoveHotelPage {
    ...
    /**
     * Launches the Remove Hotel page with specified components and layout.
     *
     * @param mainFrame The main JFrame of the application.
     * @param lorem     Text to display in the hotel list JTextArea.
     */
    ...
    /**
     * Retrieves the Submit button from the Remove Hotel page.
     *
    ...
    /**
     * Retrieves the Exit button from the Remove Hotel page.
     *
    ...
    /**
     * Retrieves the hotel number entered in the JTextField.
     *
     * @return The hotel number entered as a String.
     */
