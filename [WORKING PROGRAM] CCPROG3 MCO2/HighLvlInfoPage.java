...
/**
 * Represents the high-level information page for displaying hotel information.
 */
public class HighLvlInfoPage {
    ...
    /**
     * Launches the high-level information page with specified content.
     *
     * @param mainFrame The main JFrame of the application.
     * @param lorem     The content to display in the JTextArea (hotel information).
     */
