...
/**
 * Represents the graphical interface for creating a hotel.
 */
public class CreateHotelPage{
    ...
    /**
     * Launches the Create Hotel page on the main JFrame.
     *
    ...
    /**
     * Shows an update status label based on the operation's success.
     *
     * @param mainFrame The main JFrame of the application.
     * @param isValid   Whether the operation was successful.
     * @return JLabel representing the update status.
     */
    ...
    /**
     * Retrieves the submit button instance.
     *
    ...
    /**
     * Retrieves the hotel name entered in the text field.
     *
    ...
    /**
     * Retrieves the layered pane containing UI components.
     *
