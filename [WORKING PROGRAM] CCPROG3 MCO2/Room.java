...
public class Room {
    ...
    public int[] getAvailableDays() {
     ...
     /**
     * Retrieves a formatted string representation of all reservations.
     *
     * @return A string representation of all reservations.
     */
    public String getAllReservationString() {
        String result = "";
        int i = 1;

        for (Reservation res : reservationList) {
            result += "[" + i + "] " + res.getGuestName() + " Check-In: Day " + res.getCheckIn() + " Check-out: Day " + res.getCheckOut();
            result += "\nTotal Reservation Price: " + res.getTotalReservationPrice() + "\n";
        }
