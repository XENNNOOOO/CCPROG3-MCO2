...
/**
 * Represents the GUI page for booking reservations in a hotel reservation system.
 */
public class BookReservationPage {
    ...
    /**
     * Launches the book reservation page with specified main frame and hotel list.
     *
     * @param mainFrame The main JFrame of the application.
     * @param hotelList A string containing the list of hotels to display.
     */
    ...
    /**
     * Adds an ActionListener to the buttons in the reservation page.
     *
    ...
    /**
     * Retrieves the Standard button instance.
     *
     * @return The instance of the Standard button.
     */
    ...
    /**
     * Retrieves the Deluxe button instance.
     *
     * @return The instance of the Deluxe button.
     */
    ...
    /**
     * Retrieves the Executive button instance.
     *
     * @return The instance of the Executive button.
     */
     ...
     *
     * @return The instance of the Exit button.
     */
    ...
    /**
     * Retrieves the text entered in the Guest Name field.
     *
     * @return The text entered in the Guest Name field.
     */
    ...
    /**
     * Retrieves the text entered in the Day From field.
     *
     * @return The text entered in the Day From field.
     */
    ...
    /**
     * Retrieves the text entered in the Day To field.
     *
     * @return The text entered in the Day To field.
     */
    ...
    /**
     * Retrieves the text entered in the Discount Code field.
     *
     * @return The text entered in the Discount Code field.
     */
