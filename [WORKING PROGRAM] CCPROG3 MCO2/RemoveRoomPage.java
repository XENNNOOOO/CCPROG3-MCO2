...
/**
 * Represents a page for removing rooms in the Hotel Reservation System GUI.
 */
public class RemoveRoomPage {
    ...
    /**
     * Launches the Remove Room page with specified components and layout.
     *
     * @param mainFrame The main JFrame of the application.
     * @param lorem     Text to display in the room list JTextArea.
     */
    public void launchRemoveRoomPage(JFrame mainFrame, String lorem) {
        //Images
        ...
        exButton.setCustomBorderThickness(2);
         ...
         JLabel menuLabel = new JLabel("REMOVE ROOM");
    ...
    /**
     * Retrieves the Submit button from the Remove Room page.
     *
    ...
    public RoundedButton getSubButton() {
     ...
     /**
     * Retrieves the Exit button from the Remove Room page.
     *
