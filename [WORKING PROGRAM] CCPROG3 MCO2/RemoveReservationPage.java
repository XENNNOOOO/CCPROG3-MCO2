...
/**
 * Represents a page for removing reservations in the Hotel Reservation System GUI.
 */
public class RemoveReservationPage {
    ...
    /**
     * Launches the Remove Reservation page with specified components and layout.
     *
     * @param mainFrame The main JFrame of the application.
     * @param lorem     Text to display in the reservation list JTextArea.
     */
    ...
    /**
     * Retrieves the Submit button from the Remove Reservation page.
     *
    ...
    /**
     * Retrieves the Exit button from the Remove Reservation page.
     *
    ...
    /**
     * Retrieves the prompt label that indicates whether to enter a Room # or Reservation #.
     *
     * @return The JLabel instance for the prompt label.
     */
    public JLabel getPromptLbl() {
        return promptLbl;
    }

    /**
     * Retrieves the room number entered in the JTextField.
     *
     * @return The room number entered as a String.
     */
