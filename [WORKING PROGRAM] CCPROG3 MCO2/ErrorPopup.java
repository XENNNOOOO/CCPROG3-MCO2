...
/**
 * Represents a popup window to display an error message.
 */
public class ErrorPopup extends JFrame{
    ...
    /**
     * Launches the error popup window with a specified error image.
     *
     * @param errorImage The ImageIcon to display as the error background.
     */
