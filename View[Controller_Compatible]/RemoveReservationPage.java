...
public class RemoveReservationPage {
    ...
    //first click of submit button the room list must show
    //after the first click the prompt must change from
    //room number to reseration number, the string in the
    //param must also be changed.
